...
describe("Modal", () => {
    ...
    it("should match snapshot", () => {
        ...
        let view = render(<PhotoModal modalOpen={open} setModalOpen={setModalOpen} setImgUrl={setImgUrl} setPhotoTitle={setPhotoTitle}/>);
    ...
    it('should close', () => {
        render(<PhotoModal modalOpen={open} setModalOpen={setModalOpen} setImgUrl={setImgUrl} setPhotoTitle={setPhotoTitle}/>);
